...
const loadWeather = (lat, lon) => {
    const query = 'https://api.openweathermap.org/data/2.5/weather?lat='+ lat +'&lon='+ lon +'&appid=cb3f5848dbe56a372daeb806652e800e&units=metric';
